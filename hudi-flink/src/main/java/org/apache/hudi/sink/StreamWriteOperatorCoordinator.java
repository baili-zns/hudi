...
public class StreamWriteOperatorCoordinator
    ...
    private void handleEndInputEvent(WriteMetadataEvent event) throws IOException {
...
//                    this.writeClient = new HoodieFlinkWriteClient<>(this.writeClient.getEngineContext(), writeConfig);
     ...
     * Commits the instant.
     */
    private void commitInstant(String instant) throws IOException {
     ...
     */
    private boolean commitInstant(String instant, long checkpointId) throws IOException {
